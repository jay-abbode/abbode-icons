...
/**
 * /webster — the Webster board, and the only surface the floor team needs:
 ...
 * configs, and the Abbode fleet — lives on Thread Config (/machines),
 * untouched.
 */
      ...
      <main className="mx-auto max-w-5xl px-5 pb-24 pt-6 lg:px-8">
        <div className="mb-6 flex flex-wrap items-end justify-between gap-3">
          ...
          <div className="font-ui flex items-center gap-4 text-xs">
            ...
            <Link href="/machines" className="text-ink-muted transition-colors hover:text-espresso">
              Thread Config →
            </Link>
          </div>
        </div>
