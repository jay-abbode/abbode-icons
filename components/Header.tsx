...
/**
 * Little row of spools — used on the "Thread Config" button so it reads as an
 * embroidery/thread control at a glance.
 */
function SpoolsIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden="true">
      <circle cx="5.5" cy="12" r="3.1" />
      <circle cx="12" cy="12" r="3.1" />
      <circle cx="18.5" cy="12" r="3.1" />
    </svg>
  );
}
