 ...
 * catalog thread colors). Sibling to ColorDataMenu and styled to match it:
 * a sorted list, top 15 emphasized, the rest faded. Data comes precomputed
 * from the ORDER_STATS sheet tab via getOrderStats().
 */
