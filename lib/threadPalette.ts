...
export const THREAD_PALETTE: ThreadColor[] = [
  ...
  { slot: 1,  code: "1747", name: "Dark Red",        rgb: [152,  42,  49] },
  { slot: 4,  code: "1621", name: "Rust Orange",     rgb: [186,  92,  42] },
  ...
  { slot: 10, code: "1769", name: "Olive Green",     rgb: [ 92, 117,  44] },
  { slot: 12, code: "1902", name: "Dark Green",      rgb: [ 45,  71,  53] },
  { slot: 13, code: "1648", name: "Matcha Green",    rgb: [141, 161,  99] },
  { slot: 17, code: "1675", name: "Cool Periwinkle", rgb: [166, 220, 252] },
  { slot: 19, code: "1843", name: "Dark Royal",      rgb: [ 38,  75, 123] },
  { slot: 20, code: "1643", name: "Navy",            rgb: [ 46,  59,  71] },
  { slot: 21, code: "1832", name: "Purple",          rgb: [103,  87, 155] },
  { slot: 27, code: "1917", name: "Dusty Pink",      rgb: [200, 122, 139] },
